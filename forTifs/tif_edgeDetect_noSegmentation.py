...
Call the script with "python edgeDetect_noSegmentation.py $tif_filename" where $tif_filename is your file. 
Call the script on 8 random images in a folder with "bash runDetectRandom8files.sh". 
